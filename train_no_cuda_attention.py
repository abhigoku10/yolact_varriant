...
# Oof
import eval_attn as eval_script
...
def train():
    ...
    # print('++++++++++++++++++++++++++', cfg.dataset.train_images)
    # print(stop)
    ...
    try:
        for epoch in range(num_epochs):
            ...
            for datum in data_loader:
                ...
                images, targets, masks, num_crowds, daytime_val = prepare_data(datum)
                # print('please please please please', daytime_val)
                # Forward Pass

                #out, proborloss = net([images, daytime_val])
                out = net(images)


                # print('####################', proborloss, '\n')
                # print('=============', out.keys(), '\n@@@@@@@@@@@@@', out.values(), type(out), len(out))
                ...
                # print('losssssssssssssssssssss', loss, type(loss))
                
                #loss = loss+proborloss
...
def prepare_data(datum):
    images, (targets, masks, num_crowds), daytime_val = datum
    ...
    return images, targets, masks, num_crowds, daytime_val
