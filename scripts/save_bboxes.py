...
COCO_ROOT = osp.join('/media/priyankaa_e/priya/yolact-master_old/data/coco/images')

annotation_file = '/home/priyankaa_e/train_json_3aug.json'
annotation_path = osp.join(annotation_file)
