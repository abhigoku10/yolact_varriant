...
from backbone.backbone import construct_backbone
...
class Yolact(nn.Module):
    ...
    def forward(self, x):
        ...
        with timer.env('backbone'):
            outs, daytime_data = self.backbone(x)
        ...
        if self.training:
            ...
            return self.detect(pred_outs), daytime_data
